...
const PIN_LIST: PinData[] = [
  ...
  { num: 23, minName: "/TEST", maxName: "/TEST", category: "control", direction: "Input", desc: "Test input sampled by WAIT instruction.", minDetail: "Synchronizes with 8087 coprocessor.", maxDetail: "Synchronizes with 8087 coprocessor." },
  { num: 24, minName: "INTA", maxName: "QS1", category: "status", direction: "Output", desc: "Min: Interrupt Acknowledge | Max: Queue Status 1", minDetail: "MIN: Interrupt acknowledge pulse.", maxDetail: "MAX: Instruction queue status 1." },
  { num: 25, minName: "ALE", maxName: "QS0", category: "control", direction: "Output", desc: "Min: Address Latch Enable | Max: Queue Status 0", minDetail: "MIN: Address latch enable pulse.", maxDetail: "MAX: Instruction queue status 0." },
  { num: 26, minName: "/DEN", maxName: "/S0", category: "control", direction: "Output", desc: "Min: Data Enable | Max: Status Line 0", minDetail: "MIN: Active-low transceiver enable.", maxDetail: "MAX: Status output line 0." },
  { num: 27, minName: "DT//R", maxName: "/S1", category: "control", direction: "Output", desc: "Min: Data Transmit/Receive | Max: Status Line 1", minDetail: "MIN: Transceiver direction control.", maxDetail: "MAX: Status output line 1." },
  { num: 28, minName: "M//IO", maxName: "/S2", category: "control", direction: "Output", desc: "Min: Memory / I/O select | Max: Status Line 2", minDetail: "MIN: HIGH for Memory, LOW for I/O.", maxDetail: "MAX: Status output line 2." },
  { num: 29, minName: "/WR", maxName: "/LOCK", category: "control", direction: "Output", desc: "Min: Write Strobe | Max: Bus Lock Output", minDetail: "MIN: Active-low write strobe.", maxDetail: "MAX: Bus lock prefix output." },
  { num: 30, minName: "HLDA", maxName: "/RQ//GT1", category: "control", direction: "Output", desc: "Min: Hold Acknowledge | Max: Request/Grant 1", minDetail: "MIN: Hold acknowledge output.", maxDetail: "MAX: Bidirectional bus request/grant 1." },
  { num: 31, minName: "HOLD", maxName: "/RQ//GT0", category: "control", direction: "Input", desc: "Min: Hold Request | Max: Request/Grant 0", minDetail: "MIN: Hold request input.", maxDetail: "MAX: Bidirectional bus request/grant 0." },
  { num: 32, minName: "/RD", maxName: "/RD", category: "control", direction: "Output", desc: "Read Strobe signal.", minDetail: "Active-low read strobe.", maxDetail: "Active-low read strobe." },
  { num: 33, minName: "MN//MX", maxName: "MN//MX", category: "system", direction: "Input", desc: "Minimum / Maximum Mode selection pin.", minDetail: "Wired to Vcc (+5V) for MIN mode.", maxDetail: "Wired to GND (0V) for MAX mode." },
  { num: 34, minName: "/BHE / S7", maxName: "/BHE / S7", category: "address-data", direction: "Output", desc: "Bus High Enable / Status S7.", minDetail: "Enables upper byte data bus D8-D15.", maxDetail: "Enables upper byte data bus D8-D15." },
  { num: 35, minName: "A19 / S6", maxName: "A19 / S6", category: "address-data", direction: "Output", desc: "Address Line 19 / Status S6.", minDetail: "Upper address bit A19 / Status S6.", maxDetail: "Upper address bit A19 / Status S6." },
  { num: 36, minName: "A18 / S5", maxName: "A18 / S5", category: "address-data", direction: "Output", desc: "Address Line 18 / Status S5.", minDetail: "Upper address bit A18 / Status S5 (IF flag).", maxDetail: "Upper address bit A18 / Status S5 (IF flag)." },
  { num: 37, minName: "A17 / S4", maxName: "A17 / S4", category: "address-data", direction: "Output", desc: "Address Line 17 / Status S4.", minDetail: "Upper address bit A17 / Status S4 (Segment).", maxDetail: "Upper address bit A17 / Status S4 (Segment)." },
  { num: 38, minName: "A16 / S3", maxName: "A16 / S3", category: "address-data", direction: "Output", desc: "Address Line 16 / Status S3.", minDetail: "Upper address bit A16 / Status S3 (Segment).", maxDetail: "Upper address bit A16 / Status S3 (Segment)." },
